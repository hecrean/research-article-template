...
export class ListManager {
	...
	set(list) {
		...
		(_a = this.lists.get(list.name)) === null || _a === void 0
			? void 0
			: _a.set(list.parentID || this.rootID, new List({ ...list, manager: this }));
	}
...
export class List {
	...
	*[Symbol.iterator]() {
		for (let record of flattenList(
			this.cache._internal_unstable.storage.get(this.recordID, this.key).value
		)) {
			yield record;
		}
	}
